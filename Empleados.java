...
public class Empleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EmpleadosVentana1.setText("    Administración");
        ...
        if (InformacionEmpleados.getColumnModel().getColumnCount() > 0) {
            InformacionEmpleados.getColumnModel().getColumn(6).setHeaderValue("Contraseña");
        }
        ...
        Reportes.setBackground(new java.awt.Color(0, 153, 255));
        Reportes.setFont(new java.awt.Font("Roboto SemiCondensed ExtraBold", 1, 36)); // NOI18N
        ...
        jPanel3.add(Reportes, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 580, 340, 50));

        jLabel2.setFont(new java.awt.Font("Roboto Condensed ExtraBold", 1, 48)); // NOI18N
        jLabel2.setText("Empleados");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, -1, -1));

        jSeparator3.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator3.setForeground(new java.awt.Color(0, 0, 0));
        jPanel3.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 850, 20));
    ...
    private void ReportesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReportesActionPerformed
        // TODO add your handling code here:
        Reportes ventana = new Reportes(dniUsuario, contrasenaUsuario);
