...
public class Historial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButtonBuscadorPorPlaca1 = new javax.swing.JToggleButton();
        jToggleButtonBuscadorPorPlaca2 = new javax.swing.JToggleButton();
        jToggleButtonBuscadorPorPlaca3 = new javax.swing.JToggleButton();
        ...
        jTableInformacion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DNI", "Nombre", "Apellido", "Placa", "Ingreso", "Salida", "Espacio", "Estado", "Cobro"
            }
        ) {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 180, 800, 140));

        jTextFieldBuscadorPorPlaca.setForeground(new java.awt.Color(204, 204, 204));
        jTextFieldBuscadorPorPlaca.setText("Placa");
        jPanel2.add(jTextFieldBuscadorPorPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 120, 340, 30));

        jToggleButtonBuscadorPorPlaca.setBackground(new java.awt.Color(51, 204, 0));
        jToggleButtonBuscadorPorPlaca.setFont(new java.awt.Font("Roboto ExtraBold", 1, 12)); // NOI18N
        jToggleButtonBuscadorPorPlaca.setForeground(new java.awt.Color(255, 255, 255));
        jToggleButtonBuscadorPorPlaca.setText("Mas Información");
        jPanel2.add(jToggleButtonBuscadorPorPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 120, -1, 30));

        jToggleButtonBuscadorPorPlaca1.setText("Buscar");
        jPanel2.add(jToggleButtonBuscadorPorPlaca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 120, -1, 30));

        jToggleButtonBuscadorPorPlaca2.setBackground(new java.awt.Color(255, 204, 0));
        jToggleButtonBuscadorPorPlaca2.setText("Editar");
        jPanel2.add(jToggleButtonBuscadorPorPlaca2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 120, -1, 30));

        jToggleButtonBuscadorPorPlaca3.setBackground(new java.awt.Color(255, 51, 51));
        jToggleButtonBuscadorPorPlaca3.setForeground(new java.awt.Color(255, 255, 255));
        jToggleButtonBuscadorPorPlaca3.setText("Eliminar");
        jPanel2.add(jToggleButtonBuscadorPorPlaca3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 120, -1, 30));
    ...
    private javax.swing.JToggleButton jToggleButtonBuscadorPorPlaca1;
    private javax.swing.JToggleButton jToggleButtonBuscadorPorPlaca2;
    private javax.swing.JToggleButton jToggleButtonBuscadorPorPlaca3;
